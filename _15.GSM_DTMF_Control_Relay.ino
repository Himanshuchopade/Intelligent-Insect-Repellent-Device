...
void setup() 
{
    pinMode(2,OUTPUT);                    //Set pin number 4 as digital out where relay 1 is connected
    pinMode(3,OUTPUT);                    //Set pin number 5 as digital out where relay 2 is connected
...
//    lcd.print("GSM DTMF Test....");       //Print the message as metioned cursor location
    ...
    delay(300);
    Serial.println("ATS0=2");             //Automatically answer call after 1 ring
    delay(300);
